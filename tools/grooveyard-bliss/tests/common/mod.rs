...
pub fn create_test_wav(dir: &TempDir, filename: &str, frequency: f32, duration_secs: f32) -> PathBuf {
    create_test_wav_at(dir.path(), filename, frequency, duration_secs)
}

pub fn create_test_wav_at(dir: &std::path::Path, filename: &str, frequency: f32, duration_secs: f32) -> PathBuf {
