...
from librarian.daemon import run_daemon
from librarian.report import print_report, save_report
...
def main():
    ...
    if args.command == "scan":
        ...
        import uvicorn
        from librarian.api import create_app
        app = create_app()
        uvicorn.run(app, host=args.host, port=args.port, log_level="info")

    elif args.command == "worker":
        from librarian.worker import run_worker
        run_worker(config)
