...
from librarian.db import init_db, claim_next_task, update_task, save_scan_result, create_task, set_cache, get_cache, list_tasks, get_task
from librarian.scanner import LibraryScanner
from librarian.report import save_report
from librarian.artwork import scan_missing_covers, fetch_cover_from_caa, save_cover
from librarian.matcher import match_album, apply_match
from librarian.audio import get_audio_files
from librarian.lastfm import get_artist_info, get_best_artist_image
...
def _handle_scan(task_id: str, params: dict, config: dict) -> dict:
    from librarian.scanner import SCANNER_ORDER
