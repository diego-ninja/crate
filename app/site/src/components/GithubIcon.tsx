/**
 * Hand-rolled GitHub glyph — the vendored lucide-react version we use
 * elsewhere in the repo doesn't ship one, and we'd rather not add a
 * dedicated icon dep for one mark.
 */
