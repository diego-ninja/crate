          ...
          {filtersLoading ? (
            ...
            <>
              ...
              <button
                ...
                className="group flex w-full items-center gap-4 rounded-xl border border-primary/15 bg-primary/5 p-4 text-left transition hover:border-primary/30 hover:bg-primary/10"
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-0.5 text-[12px] text-white/50">
                    Trace a listening route between any two artists, genres, or tracks
                  </div>
                </div>
