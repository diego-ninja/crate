...
from musicdock.db import init_db, get_setting, set_setting, list_tasks, set_cache
...
class Orchestrator:
    ...
    def run(self):
        ...
        while not self._shutdown:
            ...
            if now - last_schedule_check > 60:
                ...
                try:
                    from musicdock.scheduler import check_and_create_scheduled_tasks
    ...
    def _cleanup_orphaned_tasks(self):
        ...
        try:
            from musicdock.db import update_task
...
def _worker_process_entry(config: dict, worker_id: int, max_tasks: int, max_rss_mb: int):
    ...
    from musicdock.db.core import _reset_pool
    _reset_pool()
    ...
    from musicdock.worker import TASK_HANDLERS, _is_cancelled
    from musicdock.db import claim_next_task, update_task, get_setting, get_task
