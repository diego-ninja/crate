...
from musicdock.db import get_db_ctx, create_task
...
def setup_create_admin(body: SetupAdminRequest):
    ...
    from musicdock.db import create_user
...
def setup_save_keys(request: Request, body: SetupKeysRequest):
    ...
    from musicdock.db import set_setting
    keys = {
...
def setup_check(request: Request):
    ...
    from musicdock.db import get_setting, get_library_stats
